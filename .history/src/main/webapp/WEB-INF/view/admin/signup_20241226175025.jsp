...
<body class="grid place-content-center bg-sky-200 text-base h-screen">
    <div class="container grid bg-sky-600 justify-items-center gap-4 rounded text-white">
        ...
        <form action="dashboard" method="get" class="grid place-items-center text-black w-40 gap-1">
    		<input type="text" class="text-black p-2 text-xs rounded border border-black" name="firstName" placeholder="Enter first name" required> <br>
    		<input type="text" class="text-black p-2 text-xs rounded border border-black" name="lastName" placeholder="Enter last name" required> <br>
