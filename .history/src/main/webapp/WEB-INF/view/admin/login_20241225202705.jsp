...
<body class="grid place-content-center bg-sky-200">
    <div class="container grid bg-sky-600 justify-items-center gap-4 rounded m-5">
        ...
        <form action="dashboard" method="get" class="grid place-items-center">
    		<input type="email" class="p-3" name="email" placeholder="Enter email" required> <br>
    		<input type="password" class="p-3" name="password" placeholder="Enter password" required> <br>
    		<button type="submit" class="p-2 bg-cyan-300 rounded">Login</button>
		</form>
    </div>
</body>
</html>