...
<body>
    ...
    <div class="sidebar">
        ...
        <form action="user" method="get">
            <button type="submit" class="button button1"><img src="<c:url value='/resources/image/user.png' />" alt="home logo" class="home"> User <img src="<c:url value='/resources/image/arrow.png' />" alt="" class="arrow"></button> <br>
        </form>
    </div>
