...
<head>
    ...
    <style><%@include file="/resources/style/schoolStyle/channel.css"%></style>
</head>
<body>
    <div class="header">
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="content-library">
                    ...
                    <a href="https://www.youtube.com/@tvpsssksripetaling4183"><img src="<c:url value='/resources/image/Channel2.png' />" alt="" class="channel"></a>
                    <a href="https://www.youtube.com/@TVPSSTBS"><img src="<c:url value='/resources/image/channel3.png' />" alt="" class="channel"></a>
                    <a href="https://www.youtube.com/@tvpssskportdickson4947"><img src="<c:url value='/resources/image/channel4.png' />" alt="" class="channel"></a>
                </div>
            </div>
        </div>
    </div>
